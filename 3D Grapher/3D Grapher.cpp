...
int main(int argc, char** argv) 
{
	...
	VectorFunction* test1 = new VectorFunction("(2*e)^(cos(t*0.005)*tan(cos(t)))", "(2*e)^(cos(t*0.005)*tan(sin(t)))", "sin(t*0.005)");
	curve[0] = new Curve(test1, -100*pi<float>(), 100*pi<float>(), 4096, .01 );
